  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      ...
      <form onSubmit={onSubmit} className="space-y-4 glass p-6 rounded-2xl border border-white/10">
        ...
        <button className="w-full px-4 py-2 rounded-xl bg-brand-600 hover:bg-brand-500">Login</button>
        <div className="text-sm text-slate-400">
          No account? <Link to="/register" className="text-brand-300">Register</Link>
        </div>
      </form>
    </div>
  );
